...
import SvgFile from "../../../components/icons/File";
...
const initialData = [
  ...
  },
  {
    ...
    dated: "2023-09-30",
    remarks:
      "Morning duisudsudusdsidusudsudisudisudisudusdis udsuid syudysyuds hsdhsuudusyd hshdusd",
    validity: "30 days",
  },
];
...
const ContainerAllotment = () => {
  ...
  return (
    <Layout>
            ...
            <div className="p-[1px] rounded-lg mt-6 bg-gradient-to-r from-pink-400 to-blue-400">
              <div className="bg-white rounded-lg p-4 w-fit">
                <table className="border-collapse">
                  <thead>
                    <tr>
                      <th className="p-3 border-b border-gray-200 text-center text-xs font-semibold min-w-6 align-text-top">
                        Sr No
                      </th>
                      <th className="p-3 border-b border-gray-200 text-center text-xs font-semibold min-w-32 align-middle">
                        Container No
                      </th>
                      <th className="p-3 border-b border-gray-200 text-center text-xs font-semibold min-w-20 align-middle">
                        Size
                      </th>
                      <th className="p-3 border-b border-gray-200 text-center text-xs font-semibold min-w-24 align-middle">
                        Allotment
                      </th>
                      <th className="p-3 border-b border-gray-200 text-center text-xs font-semibold min-w-32 align-middle">
                        Shipping Line
                      ...
                      <th className="p-3 border-b border-gray-200 text-left text-xs font-semibold max-w-96 align-middle">
                        Remarks
                      </th>
                      <th className="p-3 border-b border-gray-200 text-center text-xs font-semibold min-w-24 align-middle">
                        Action
                  ...
                  <tbody>
                    {data.map((row, index) => (
                      <tr key={row.srNo} className="hover:bg-gray-50">
                        <td className="p-3 border-b border-gray-200 text-center text-xs w-16 align-text-top">
                          {row.srNo}
                        </td>
                        <td className="p-3 border-b border-gray-200 text-center text-xs align-text-top">
                          <select
                            ...
                            onChange={(e) =>
                              handleContainerChange(index, e.target.value)
                            }
                        ...
                        <td className="p-3 border-b border-gray-200 text-center text-xs w-20 align-text-top">
                          {row.size}
                        </td>
                        ...
                        <td className="p-3 border-b border-gray-200 text-center text-xs w-32 align-text-top">
                          {row.shippingLine}
                        </td>
                        <td className="p-3 border-b border-gray-200 text-center text-xs w-32 align-text-top">
                          {row.allotmentDate}
                        ...
                        <td className="p-3 border-b border-gray-200 text-left text-xs max-w-64 align-text-top">
                          {row.remarks}
                        </td>
                        <td className="p-3 border-b border-gray-200 text-center text-xs w-24 align-text-top">
      ...
      <button
        className="bg-gray-200 p-1 rounded-md transition-colors h-8 w-8 flex items-center justify-center"
        onClick={() => handleRemove(index)}
      >
        <SvgRemove className="h-5 w-5 fill-red-500 hover:fill-red-600" />
      </button>
    </div>
                        </td>
                      </tr>
