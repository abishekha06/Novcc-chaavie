...
<button className="bg-blue-500 text-white px-6 h-8 text-xs hover:bg-blue-600 transition-all duration-200 cursor-pointer w-40">
Pre-Load List
</button>
<button className="bg-gray-200 text-gray-800 px-6 h-8 text-xs hover:bg-blue-200 transition-all duration-200 cursor-pointer w-40">
Final Load List
</button>
</div>
