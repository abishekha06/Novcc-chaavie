...
const Mainside = () => {
    return (
      ...
      <div className="w-full justify-between items-center flex flex-col gap-4">
              <img className="object-cover h-16 w-full" src="https://images.unsplash.com/photo-1554151228-14d9def656e4?q=80&w=1972&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" />
      
              <div className="h-10 w-10 rounded-full bg-pink-800"></div>
      </div>
